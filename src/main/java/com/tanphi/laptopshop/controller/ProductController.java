...
//	            @RequestParam(required = false) Integer fromPriceRange,
//	            @RequestParam(required = false) Integer toPriceRange
//	    ) {
//	        List<Product> products = ProductRepo.findByCpuContainingAndGraphicsCardContainingAndRamContainingAndScreenSizeContainingAndStorageCapacityContainingAndUnitpriceBetween(
//	                cpu != null ? cpu : "",
//	                graphicsCard != null ? graphicsCard : "",
//	                ram != null ? ram : "",
//	                screenSize != null ? screenSize : "",
//	                storageCapacity != null ? storageCapacity : "",
//	                fromPriceRange != null ? fromPriceRange : 0,
//	                toPriceRange != null ? toPriceRange : 100000000
//	        );
//	        return products;
//	    }
	
	 @GetMapping("/filter")
	    public List<Product> findByCpuContainingAndGraphicscardContainingAndRamContainingAndScreensizeContainingAndStoragecapacityContainingAndUnitpriceBetweenAndProducerContaining(@RequestParam(required = false) String cpu,
	                                         @RequestParam(required = false) String graphicscard,
	                                         @RequestParam(required = false) String ram,
	                                         @RequestParam(required = false) String screensize,
	                                         @RequestParam(required = false) String storagecapacity,
		 ...
		 List<Product> products = productService.findByCpuContainingAndGraphicscardContainingAndRamContainingAndScreensizeContainingAndStoragecapacityContainingAndUnitpriceBetweenAndProducerContaining(
	                cpu != null ? cpu : "",
	                		graphicscard != null ? graphicscard : "",
                ram != null ? ram : "",
               screensize != null ? screensize : "",
...
// return (List<Product>) ResponseEntity.ok().body(products);
 return products;
	 }
}
